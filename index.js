import { LinkedList, LinkedList , Node } from "./linkedList";
...
console.log(linkedList.size(2)); // Node { value: 'test3', nextNode: null }
console.log(linkedList.size(4)); // There is no item for this index
linkedList.pop();
